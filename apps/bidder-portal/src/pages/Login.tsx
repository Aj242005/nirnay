          ...
          <CardContent className="p-8 space-y-8">
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground mt-1">Bidder Portal</p>
              </div>
            </div>
            ...
            <p className="text-[11px] text-center text-muted-foreground">By signing in, you agree to the Terms of Service and Privacy Policy.</p>
          </CardContent>
        </Card>
      </motion.div>
    </div>
