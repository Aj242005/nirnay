...
import {
  LayoutDashboard, FileText, Upload, Search, Shield, ClipboardCheck,
  Bell, Download, ChevronLeft, ChevronRight, LogOut, Scale, Menu,
} from 'lucide-react';
...
const navItems = [
  ...
  { to: '/credibility', icon: Shield, label: 'Credibility' },
  { to: '/review', icon: Search, label: 'Review Queue' },
          ...
          <div className="flex items-center gap-3 rounded-lg px-3 py-2">
            ...
            <AnimatePresence>
              {!collapsed && (
                ...
                >
                  <p className="text-sm font-medium truncate">{user?.displayName || 'Officer'}</p>
                  <p className="text-xs text-muted-foreground truncate">{user?.role || 'officer'}</p>
                </motion.div>
              )}
            </AnimatePresence>
            {!collapsed && (
